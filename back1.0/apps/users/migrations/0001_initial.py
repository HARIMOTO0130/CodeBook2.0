...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('default_language', models.CharField(default='python', max_length=50, verbose_name='默认编程语言')),
                ('code_theme', models.CharField(default='vs-dark', max_length=50, verbose_name='代码编辑器主题')),
